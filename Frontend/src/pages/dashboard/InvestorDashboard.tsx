...
export const InvestorDashboard: React.FC = () => {
  ...
  const trackedIndustries =
    typeof dashboardSummary.trackedIndustries === "number"
      ? dashboardSummary.trackedIndustries
      : industries.length;
  const activePortfolio =
    typeof dashboardSummary.activePortfolio === "number"
      ? dashboardSummary.activePortfolio
