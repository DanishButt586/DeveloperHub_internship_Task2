...
export const SettingsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setLocation(user.location || user.preferences?.locations?.[0] || "");
    setBio(user.bio || "");
    setProfilePictureUrl(user.profilePictureUrl || user.avatarUrl || "");
  }, [user]);
  ...
  const handleSave = async () => {
    ...
    try {
      await updateProfile(user.id, {
        ...
        ...(user.role === "entrepreneur" ? { location } : {}),
      });
    } finally {
      setIsSaving(false);
    }
          ...
          <Card>
            ...
            <CardBody className="space-y-6">
              <div className="flex items-center gap-6">
                <Avatar
                  src={profilePictureUrl || user.avatarUrl}
                  alt={user.name}
                  size="xl"
                />
